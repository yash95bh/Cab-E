...
public class MapAnimator {
    ...
    public static Polyline backgroundPolyline;

    public static Polyline foregroundPolyline;
...
//        }
        ...
        PolylineOptions optionsBackground = new PolylineOptions().add(bangaloreRoute.get(0)).color(Color.BLACK).width(6);
        backgroundPolyline = googleMap.addPolyline(optionsBackground);

        optionsForeground = new PolylineOptions().add(bangaloreRoute.get(0)).color(Color.GRAY).width(6);
