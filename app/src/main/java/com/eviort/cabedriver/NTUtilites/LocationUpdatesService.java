...
//            Log.i(TAG, "7car Driver app is active");
//
...
//    }
    ...
    public boolean onUnbind(Intent intent) {
        ...
        if (SharedHelper.getKey(getApplicationContext(), "showforegroundLocation").equals("false")) {
            stopForeground(true);
            mChangingConfiguration = false;
        } else {
            // Called when the last client (MainActivity in case of this sample) unbinds from this
            ...
            // do nothing. Otherwise, we make this service a foreground service.
            if (!mChangingConfiguration && Utilities.requestingLocationUpdates(this)) {
                Log.i(TAG, "Oktaxi Driver app is active");
    ...
    private Notification getNotification() {
        ...
        CharSequence text = "Cab-E " + getString(R.string.app_active);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                /*   .addAction(R.drawable.notification_logo, getString(R.string.launch_activity),
